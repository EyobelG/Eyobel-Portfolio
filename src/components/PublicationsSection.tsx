              ...
              >
                <div className="flex items-start justify-between gap-2">
                  ...
                  <span className={`font-mono text-[10px] px-1.5 py-0.5 rounded ${
                    isActive ? "bg-williams-purple-dark text-williams-gold border border-williams-purple-light/20" : "bg-cream-card-sub border border-cream-border text-charcoal-light"
                  }`}>
                    {pub.year}
                  </span>
                </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 py-4 border-y border-cream-border text-xs">
                <div className="space-y-1">
                  ...
                  <p className="text-charcoal leading-relaxed font-sans">{pub.authors}</p>
                </div>
                <div className="space-y-1">
                  <span className="font-mono text-charcoal-light uppercase font-semibold block text-[10px]">Publication Venue:</span>
                  <p className="text-charcoal leading-relaxed font-serif font-semibold">{pub.venue} • {pub.year}</p>
                </div>
              </div>
